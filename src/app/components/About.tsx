          ...
          >
            ...
            <div className="space-y-6 mb-12">
              ...
              >
                ...
                figurativnog i ekspresivnog diskursa. Nakon završene Srednje
                škole primijenjenih umjetnosti u Sarajevu, diplomirao je
                slikarstvo na Akademiji likovnih umjetnosti u Sarajevu.
              </p>
              <p
                className="text-[#8a8580] font-['Outfit'] text-[15px] leading-relaxed"
                style={{ fontWeight: 300 }}
              >
                ...
                identiteta. U radovima je prisutna emotivna rezonanca koja
                proizlazi iz ličnog iskustva, ali je oblikovana univerzalnim
                simbolima. Smajlović gradi kompoziciju kroz slojevitu strukturu
                boje i materijala, gdje površina platna postaje polje napetosti
                između unutrašnjeg i spoljašnjeg svijeta.
              </p>
              <p
                className="text-[#8a8580] font-['Outfit'] text-[15px] leading-relaxed"
                style={{ fontWeight: 300 }}
              >
                Član je Udruženja likovnih umjetnika Likum '76 iz Visokog, kroz
                koje aktivno doprinosi razvoju lokalne likovne scene. Izlagao je
                na samostalnim i grupnim izložbama u Bosni i Hercegovini i
                regiji.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-12 gap-y-8 pt-8 border-t border-white/10">
              {stats.map((stat, i) => (
                ...
                >
                  ...
                  <p
                    className="text-[#8a8580] font-['Outfit'] text-[12px] tracking-[0.15em] uppercase mt-1"
                    style={{ fontWeight: 300 }}
                  >
                    {stat.label}
                  </p>
